                      ...
                      @if($cars ->count())
                        ...
                        <tr>
                          ...
                          <td width="150">
                            ...
                            <a href="{{ route('cars.destroy', $car->id)}}" class="btn-delete btn btn-sm btn-circle btn-outline-danger" title="Delete" onclick="confirm('Are you sure?')"><i class="fa fa-times"></i></a>
                          </td>
                        </tr>
                        @endforeach
                      @endif
